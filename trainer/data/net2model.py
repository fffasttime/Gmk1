...
x = [
    tf.placeholder(tf.float32, [None, settings.INPUT_CHANNELS, settings.BSIZE * settings.BSIZE]),
    tf.placeholder(tf.float32, [None, settings.BSIZE * settings.BSIZE]),
    tf.placeholder(tf.float32, [None, 1])
    ]

tfprocess = TFProcess(None, "temp/temp")
'''
